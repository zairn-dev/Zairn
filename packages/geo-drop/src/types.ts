 ...
 */
export type ProofMethodType = 'gps' | 'secret' | 'ar' | 'zkp' | 'custom';
...
export interface ProofRequirement {
   ...
   * - zkp: { verification_key: object; artifacts_url?: string } — Groth16 verification key for ZK proximity proof. artifacts_url points to compiled circuit WASM/zkey
...
export interface ProofSubmission {
   ...
   * - zkp: { proof: Groth16Proof; publicSignals: string[] } — ZK proximity proof generated by snarkjs
